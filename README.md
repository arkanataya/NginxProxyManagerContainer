...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tuhc1gk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tuhc1gk.containers.anotherwebservice.com/
...
```
git clone git@github.com:arkanataya/NginxProxyManagerContainer.git
cd container-tuhc1gk
```
...
```
docker attach container-tuhc1gk
```
